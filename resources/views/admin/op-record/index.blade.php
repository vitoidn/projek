...
@section('title', 'All Operational Records')
    ...
    <div class="col-12">
        <div class="glass-card">
            <h5 class="fw-bold border-bottom pb-3 mb-3">
                <i class="ph ph-clipboard-text text-primary me-2"></i> Daftar Operational Record
            </h5>
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.op-record.show', $rec->id) }}" class="btn btn-sm btn-info text-white"><i class="ph ph-eye"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
