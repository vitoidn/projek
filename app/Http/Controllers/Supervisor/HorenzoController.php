...
class HorenzoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('supervisor.horenzo.index', compact(
            'shifts', 'processMains', 'process2Options', 'activityCodes', 'lotNumbers', 'partCodes', 'report'
        ));
    }
    ...
    public function generate(Request $request)
    {
        ...
        return redirect()->route('supervisor.horenzo.index', $request->only(['date_from', 'date_to', 'shift_id', 'process_main', 'part_code', 'lot_id', 'nik']))
            ->with('success', 'Horenzo report generated.');
    }
